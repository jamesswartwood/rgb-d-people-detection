...
int print_help() {
  ...
  std::cout << "   --conf    <minimum_HOG_confidence (default = -1.5)>"
            << std::endl;
  std::cout << "   --min_h   <minimum_person_height (default = 1.3)>"
            << std::endl;
  std::cout << "   --max_h   <maximum_person_height (default = 2.3)>"
            << std::endl;
  std::cout << "*******************************************************"
            << std::endl;
  return 0;
...
int main(int argc, char **argv) {
  ...
  std::string svm_filename = "../include/people_detection_svm.yaml";
  ...
  pcl::Grabber *interface = new pcl::RealSense2Grabber();
  ...
  people_detector.setPersonClusterLimits(min_height, max_height, 0.1,
                                         8.0); // set person classifier
  //  people_detector.setSensorPortraitOrientation(true);             // set
  //  sensor orientation to vertical
